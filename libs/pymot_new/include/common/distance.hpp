...
namespace mot {
    ...
    T bbox_iou(const Rect<T> &box1,const Rect<T> &box2) {
        ...
        T b1_x1 = std::max(box1.x, 0.d);
        T b1_y1 = std::max(box1.y, 0.d);
        T b1_x2 = std::max(box1.x + box1.w,0.d);
        T b1_y2 = std::max(box1.y + box1.h,0.d);

        T b2_x1 = std::max(box2.x,0.d);
        T b2_x2 = std::max(box2.x + box2.w,0.d);
        T b2_y1 = std::max(box2.y,0.d);
        T b2_y2 = std::max(box2.y + box2.h,0.d);
        ...
        T inter_area;
        inter_area = std::max((inter_rect_x2 - inter_rect_x1),0.d) * std::max(inter_rect_y2 - inter_rect_y1,0.d);
    ...
    T bbox_iou_shrink(const Rect<T> &box1,const Rect<T> &box2) {
        ...
        T inter_area;
        inter_area =
                std::max((inter_rect_x2 - inter_rect_x1),0.d) * std::max(inter_rect_y2 - inter_rect_y1,0.d);
        T b1_area = (b1_x2 - b1_x1) * (b1_y2 - b1_y1);
        T b2_area = (b2_x2 - b2_x1) * (b2_y2 - b2_y1);
