//Copyright (c) Supremind, Inc. and its affiliates. All Rights Reserved.

#ifndef MOT_DEMO_LOG_H
#define MOT_DEMO_LOG_H
...
#define LOG_DEBUG LogMessage("DEBUG", __FILE__, __LINE__)
